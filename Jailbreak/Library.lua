...
function Library:Window(Name, Color, SizeY)
    ...
    Main.Size = UDim2.new(0, 514, 0, SizeY)
    ...
    function WindowLibrary:Tab(Name)
        ...
        function SectionLibrary:Section(Name)
            ...
            function Functions:Toggle(Name, Func)
                ...
                function ToggleActions:GetState()
                    return getgenv()[Name]
                end

                function ToggleActions:SetState(state)
                    if state then
                        tweenProp(Toggle, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)})
                        tweenProp(TextLabel, {TextColor3 = Color3.fromRGB(77, 77, 77)})
                    else
            ...
            function Functions:Slider(Name, Max, Default, Min, Func)
                ...
                function SliderActions:GetValue()
                    return Num.Text
                end
            ...
            function Functions:ToggleSlider(Name, Max, DefVal, Min, Func)
                ...
                function ToggleSliderActions:GetState()
                    return getgenv()[Name]
                end

                function ToggleSliderActions:SetState(state, value)
                    if state then
                        tweenProp(Toggle, {BackgroundColor3 = Color3.fromRGB(45, 45, 45)})
                        tweenProp(Slider, {TextColor3 = Color3.fromRGB(77, 77, 77)})
                    else
            ...
            function Functions:Textbox(Name, PlayerHolder, Func)
                ...
                function TextboxActions:GetValue()
                    return TextBox.Text
                end

                function TextboxActions:SetText(text)
